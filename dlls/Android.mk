...
LOCAL_CFLAGS += -D_LINUX -DCLIENT_WEAPONS -DCXX_VER=\"$(CXX_VER)\" -DCXX=\"$(CXX)\" -DBMOD_BUILD_COMMIT=\"$(BMOD_COMMIT)\" -fvisibility=hidden -Dstricmp=strcasecmp -Dstrnicmp=strncasecmp -D_snprintf=snprintf \
